...
public class SelectImpl extends ElementImpl implements Select {
     ...
     * @throws NoSuchElementException If no matching option org.selophane.elements are found
     *             or the org.selophane.elements are not visible or disabled.
     */
        ...
        private void checkState(String searchCriteria) {
            ...
            case NOT_VISIBLE:
                throw new ElementNotVisibleException(
                        "You may only interact with visible org.selophane.elements" + searchCriteria);
            case DISABLED:
                throw new InvalidElementStateException(
                        "You may only interact with enabled org.selophane.elements with " + searchCriteria);
            case NOT_FOUND:
