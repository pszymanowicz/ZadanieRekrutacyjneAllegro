...
public class TableImpl extends ElementImpl implements Table {
	...
	public WebElement getName(WebElement row) {
		return row.findElement(By.xpath("td[6]"));
	}

	public WebElement getLastTime(WebElement row) {
		return row.findElement(By.xpath("td[8]"));
	}

	public List<WebElement> getAllRows(){
		List<WebElement> rows = new ArrayList<WebElement>();
		rows.addAll(findElements(By.xpath("//tbody/tr")));
		return rows;
	}
