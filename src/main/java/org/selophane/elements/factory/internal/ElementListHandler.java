...
/**
 * Wraps a list of WebElements in multiple wrapped org.selophane.elements.
 */
public class ElementListHandler implements InvocationHandler {
    ...
    /**
     * Given an interface and a locator, apply a wrapper over a list of org.selophane.elements.
     *
     * @param interfaceType interface type we're trying to wrap around the element.
     * @param locator       locator on the page for the org.selophane.elements.
